...
from dealscout.agents.frontier_agent import FrontierAgent
from dealscout.agents.neural_network_agent import NeuralNetworkAgent
from dealscout.models.preprocessor import Preprocessor
...
class EnsembleAgent(Agent):
    ...
    def __init__(self, collection):
        ...
        self.preprocessor = Preprocessor(model_name="groq/openai/gpt-oss-20b")
